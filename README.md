...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-smoke-e614
```

A live public deployment of this template is available at [https://lingering-smoke-e614.templates.workers.dev](https://lingering-smoke-e614.templates.workers.dev)
